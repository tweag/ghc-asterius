...
module GHC.Frontend.Ghc (main) where
    ...
    case mode of
        ...
        Right postStartupMode ->
            ...
            case postStartupMode of
                ...
                Right postLoadMode ->
                    main' setup_hooks postLoadMode dflags argv3 flagWarnings

main' :: Ghc () -> PostLoadMode -> DynFlags -> [Located String] -> [Warn]
      -> Ghc ()
main' setup_hooks postLoadMode dflags0 args flagWarnings = do
